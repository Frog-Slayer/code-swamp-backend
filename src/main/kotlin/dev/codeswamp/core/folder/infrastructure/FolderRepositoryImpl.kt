package dev.codeswamp.core.folder.infrastructure

import dev.codeswamp.core.folder.domain.entity.Folder
import dev.codeswamp.core.folder.domain.repository.FolderRepository
import dev.codeswamp.core.folder.infrastructure.graph.node.FolderNode
import dev.codeswamp.core.folder.infrastructure.graph.repository.FolderNodeRepository
...
class FolderRepositoryImpl(
    ...
    override fun save(folder: Folder): Folder {
        ...
        val node = FolderNode.from(saved, parentNode)
