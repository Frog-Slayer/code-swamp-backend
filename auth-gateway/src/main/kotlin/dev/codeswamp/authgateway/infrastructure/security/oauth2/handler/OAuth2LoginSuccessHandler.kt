package dev.codeswamp.authgateway.infrastructure.security.oauth2.handler
...
import dev.codeswamp.authgateway.infrastructure.security.oauth2.dto.ProviderUserInfo
import dev.codeswamp.authgateway.infrastructure.security.oauth2.factory.UserInfoFactory
...
class OAuth2LoginSuccessHandler(
    ...
    private suspend fun handleRegisteredUserAndPassTokens(response: ServerHttpResponse, user: AuthUser) {
        ...
        authApplicationService.storeRefreshToken(refreshToken)//비동기
